...
try:
   ...
   comms.rec_callback()
   navigate_to("G1")
   comms.send_repeated(dest_addr=ONYX_ADDR,movement="GATE_START",count=5,delay=0.5)
   rospy.loginfo("Passed through gate")
   comms.send_repeated(dest_addr=ONYX_ADDR,movement="GATE_FINISH",count=5,delay=0.5)
...
try:
    ...
    comms.send_repeated(dest_addr=ONYX_ADDR,movement="SLALOM_START",count=5,delay=0.5)
    navigate_to("S1")
    navigate_to("S2")
    navigate_to("S3")
    comms.send_repeated(dest_addr=ONYX_ADDR,movement="SLALOM_FINISH",count=5,delay=0.5)
    #navigate_to("S4")
...
try:
    ...
    comms.send_repeated(dest_addr=ONYX_ADDR,movement="OCTAGON_START",count=5,delay=0.5)
    navigate_to("O1")
    navigate_to("O2")
    rc.go_to_depth(0.1)
    time.sleep(3)
    comms.send_repeated(dest_addr=ONYX_ADDR,movement="OCTAGON_FINISH",count=5,delay=0.5)
    rc.go_to_depth(0.8)
...
try:
    ...
    comms.send_repeated(dest_addr=ONYX_ADDR,movement="RETURN_START",count=5,delay=0.5)
    navigate_to("R1")
    navigate_to("R2")
    comms.send_repeated(dest_addr=ONYX_ADDR,movement="RETURN_FINISH",count=5,delay=0.5)

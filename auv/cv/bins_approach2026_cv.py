"""
Bins Approach CV. Finds the bins sturcture, and approaches it until it can no longer see it.
"""
...
class CV:
    """
    Bins Approach CV class. DO NOT change the name of the class, as this will mess up all of the backend files to run the CV scripts.
    """

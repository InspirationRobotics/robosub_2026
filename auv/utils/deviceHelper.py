...
def findFromId(ids):
    ...
    bash = os.popen("bash /home/inspiration/robosub_2026/auv/utils/usbLink.sh").read() # Read usbLink.sh
...
def findCam(ids):
    ...
    bash = os.popen("bash /home/inspiration/robosub_2026/auv/utils/usbLink.sh").read()
    bash = bash.split("\n")
    result = []
